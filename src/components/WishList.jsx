    ...
    return (
        <div className="p-4 md:p-8 bg-gray-50 min-h-screen ">
            ...
            <div className="flex justify-center gap-4 mt-16">
                <button className='bg-[#D9176C1A]  outline-offset-0 outline-solid w-36.5 h-12.5 hover:bg-[#D9176C] hover:text-white transition-all text-[#D9176C] rounded-xl cursor-pointer font-semibold'>Move to cart</button>

                <button className='bg-[#D9176C]  text-white w-[320px] h-12 hover:bg-[#D9176C1A] hover:outline-offset-0 outline-solid hover:text-[#D9176C] transition-all  rounded-xl cursor-pointer flex gap-4 justify-around items-center font-semibold'><span>2 Items: <span className='font-bold'>80$</span></span>Check out <MoveRight className="bg-white text-[#D9176C] p-1 rounded-xl hover:bg-[#D9176C] hover:text-white transition-all" size={40} /></button>
