                ...
                <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 ">
                    <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 w-full max-w-lg">
                        ...
                        <Form className="space-y-4">
                            ...
                            <div className="flex gap-3 justify-center p-10 bg-[#f9f9f9] rounded-4xl">
                                <input
                                    type="text"
                                    maxLength="1"
                                    className={`w-17.5 h-17.5 text-center text-2xl font-medium rounded-[18px] bg-white border-[1.5px] outline-none transition-all duration-200 read-only:cursor-default
